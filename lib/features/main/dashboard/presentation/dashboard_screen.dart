      ...
      body: Padding(
        ...
        child: GridView.count(
          ...
          children: [
            ...
            _buildChartCard(
                'Status of Employment (Advanced Degrees)', Colors.deepOrange),
            _buildLineGraphCard(),
            _buildBarChartCard(),
          ],
        ),
                    ...
                    child: PieChart(
                      PieChartData(
                        sections: [
                          ...
                          PieChartSectionData(
                              color: Colors.green, value: 15, title: '15%'),
                          PieChartSectionData(
                              color: Colors.orange, value: 20, title: '20%'),
                          PieChartSectionData(
                              color: Colors.purple, value: 10, title: '10%'),
                          PieChartSectionData(
                              color: Colors.red, value: 18, title: '18%'),
                          PieChartSectionData(
                              color: Colors.cyan, value: 12, title: '12%'),
                        ],
                        sectionsSpace: 2,
                  ...
                  SizedBox(
                    ...
                    child: PieChart(
                      PieChartData(
                        sections: [
                          PieChartSectionData(
                              color: Colors.blue, value: 30, title: '30%'),
                          PieChartSectionData(
                              color: Colors.green, value: 40, title: '40%'),
                          PieChartSectionData(
                              color: Colors.orange, value: 20, title: '20%'),
                          PieChartSectionData(
                              color: Colors.red, value: 10, title: '10%'),
                        ],
                        sectionsSpace: 2,
                        centerSpaceRadius: 30,
                      ),
  ...
  Widget _buildBarChartCard() {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Text('Accreditation and COPC Compliance',
                style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            Expanded(
              child: BarChart(
