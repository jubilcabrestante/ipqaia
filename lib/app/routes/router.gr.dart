...
import 'package:ipqaia/app/app_viewer.dart' as _i2;
...
/// generated route for
/// [_i2.MainAppScreen]
class MainAppRoute extends _i3.PageRouteInfo<void> {
  const MainAppRoute({List<_i3.PageRouteInfo>? children})
  ...
  static _i3.PageInfo page = _i3.PageInfo(
    name,
    builder: (data) {
      return const _i2.MainAppScreen();
    },
  );
}
